...
class TestJobFSM:
    ...
    def job_fsm(self, mock_workspace):
        ...
        with (
            ...
            fsm = JobFSM(job_id="test_job_123", workspace=mock_workspace)
    ...
    def test_successful_transition(self, job_fsm):
        ...
        result = job_fsm.transition(
            to_state=JobState.QUEUED, reason="Job queued by user"
        )
    ...
    def test_invalid_transition(self, job_fsm):
        ...
        result = job_fsm.transition(to_state=JobState.COMPLETED, reason="Invalid jump")
    ...
    def test_transition_with_metadata(self, job_fsm):
        ...
        result = job_fsm.transition(
            to_state=JobState.QUEUED, reason="High priority job", metadata=metadata
        )
