                                ...
                                with patch("plotty.planner.create_multipen_svg"):
                                    with patch("plotty.planner.save_pen_mapping"):
                                        ...
                                        for i in range(2):
                                            ...
                                            optimized_file = (
                                                layers_dir
                                                / f"layer_{i:02d}_optimized.svg"
                                            )
                                            optimized_file.write_text(
                                                f"<svg><rect x='{i*10}' y='{i*10}' width='10' height='10'/></svg>"
                                            )
                            ...
                            with patch("plotty.planner.run_vpype"):
                                with patch("plotty.planner.create_multipen_svg"):
                                    with patch("plotty.planner.save_pen_mapping"):
                                        ...
                                        optimized_file = (
                                            layers_dir / "layer_00_optimized.svg"
                                        )
                                        optimized_file.write_text(
                                            "<svg><rect x='10' y='10' width='10' height='10'/></svg>"
                                        )
                                    ...
                                    with patch(
                                        ...
                                        with patch("plotty.planner.save_pen_mapping"):
                                            ...
                                            mock_prompt.assert_called_once_with(
                                                [mock_layer], available_pens
                                            )
                                            assert (
                                                result["pen_map"] == interactive_pen_map
                                            )
                            ...
                            with patch("plotty.planner.run_vpype"):
                                with patch("plotty.planner.create_multipen_svg"):
                                    with patch("plotty.planner.save_pen_mapping"):
                                        ...
                                        assert estimates["time_saved_percent"] == round(
                                            expected_time_saved, 1
                                        )
                    ...
                    "layers": [
                        {
                            "name": "layer1",
                            "svg": "layer1.svg",
                            "estimates": {"post_s": 25.0},
                        },
                        {
                            "name": "layer2",
                            "svg": "layer2.svg",
                            "estimates": {"post_s": 20.0},
                        },
                    ],
