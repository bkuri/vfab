...
class PerformanceBenchmark:
    ...
    def compare_to_baseline(self, operation_name: str) -> Dict[str, float]:
        ...
        return {
            ...
            'cpu_ratio': current.cpu_percent / baseline.cpu_percent if baseline.cpu_percent > 0 else 1.0,
            'performance_change_percent': ((baseline.operations_per_second - current.operations_per_second) / baseline.operations_per_second) * 100
        }
    
    def assert_performance_target(self, operation_name: str, max_execution_time: float, max_memory_mb: float):
...
class TestPerformanceTargets:
    ...
    def test_startup_performance(self, benchmark):
        ...
        benchmark.assert_performance_target("startup", max_execution_time=2.0, max_memory_mb=100.0)
    ...
    def test_configuration_loading_performance(self, benchmark):
        ...
        benchmark.assert_performance_target("config_loading", max_execution_time=0.1, max_memory_mb=100.0)
    ...
    def test_database_operations_performance(self, benchmark):
        ...
        benchmark.assert_performance_target("database_init", max_execution_time=0.5, max_memory_mb=100.0)
    ...
    def test_job_processing_performance(self, benchmark):
        ...
        benchmark.assert_performance_target("job_processing_simulation", max_execution_time=5.0, max_memory_mb=100.0)
    ...
    def test_memory_usage_stability(self, benchmark):
        ...
        assert memory_growth < 50.0, f"Memory grew by {memory_growth:.1f}MB, expected < 50MB"
...
class TestPerformanceRegression:
    ...
    def test_cli_command_performance(self):
        ...
        for cmd in commands_to_test:
            ...
            assert execution_time < 5.0, f"Command {cmd} took {execution_time:.2f}s, expected < 5.0s"
