"""
CLI monitor command for ploTTY real-time monitoring.

This module provides a command-line interface for connecting to the
ploTTY WebSocket server and displaying real-time updates.
"""
...
class WebSocketMonitor:
    """Real-time WebSocket monitor for ploTTY."""
    ...
    def create_header(self) -> Panel:
        """Create header panel."""
        header_text = Text()
        header_text.append("ploTTY Monitor", style="bold blue")
...
def monitor_command(
    ...
    """Connect to ploTTY WebSocket server and display real-time monitoring."""
